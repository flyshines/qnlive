...
//		//</editor-fold>
		...
		if(information.get("send_type").equals("3") || information.get("send_type").equals("2")){//用户消息
			...
			if((information.get("send_type").equals("0") && information.get("message_type").equals("0")) ||(information.get("send_type").equals("9") && information.get("message_type").equals("0")) ){//老师的语音消息
			...
			if(information.get("send_type").equals("1") || information.get("send_type").equals("7") || information.get("send_type").equals("10") || information.get("send_type").equals("11")  ){//讲师回答 和 讲师互动
