...
/*                }else if(entry.getValue() instanceof Double){
    ...
    public static void courseTranferState(long currentTime, Map<String, String> courseInfoMap) {
        ...
        if(! courseInfoMap.get("live_course_status").equals("2")&& !courseInfoMap.get("live_course_status").equals("5")){
            long courseStartTime = Long.parseLong(courseInfoMap.get("live_start_time"));
