...
@Configuration
@EnableWebMvc
@ComponentScan({"qingning.lecture.server.controller","qingning.lecture.server.advice"})
...
public class SystemConfiguration extends WebMvcConfigurerAdapter {
	...
	public ServiceManger getServiceManger() throws Exception{
		...
		serviceManger.initServer(new String[]{"classpath:qingning-lecture-server.xml"});
