...
public class ShopModuleServerImpl implements IShopModuleServer {
	...
	public Map<String,Object> createRoomDistributer(Map<String, String> reqMap) throws Exception {
		...
		//1.插入t_distributer
		if("1".equals(reqMap.get(CommonReadOperation.SYS_INSERT_DISTRIBUTER))){
	...
	@Override
	public Map<String, Object> findCourseGuestByUserAndCourse(Map<String, Object> reqMap) {
		return courseGuestMapper.findCourseGuestByUserAndCourse(reqMap);
	}
}
